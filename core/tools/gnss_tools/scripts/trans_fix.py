...
class Transfix:
    ...
    def __init__(self):
        ...
        self.mode_switch = rospy.get_param("~mode_switch", default=False)
        ...
        self.calcu_yaw_distance_th = 0.2
        self.calcu_yaw_time_th = 0.2
        ...
        self.prev_record_utm_pose = None
    ...
    def trans_fix_2_gps(self, fix_msg):
        ...
        if self.is_load_path_points:
            ...
            if nearest_index is not None:
                ...
                marker.header.stamp = fix_msg.header.stamp
    ...
    def trans_fix_2_utm(self, fix_msg):
        ...
        if self.is_first:
            ...
            self.prev_record_utm_pose = self.utm_pose
            self.is_first = False
            pass
        ...
        diff_time = (self.utm_pose.header.stamp - self.prev_utm_pose.header.stamp).to_sec() 
        print("===================>>>> distance :", distance)
        print("===================>>>> diff_time :", diff_time)
        if distance > 0.2 or diff_time > 0.2:
        ...
        if True:
            ...
            self.utm_pose_path.header.stamp = fix_msg.header.stamp
