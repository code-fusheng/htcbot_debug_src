...
{
  static const size_t packet_size = sizeof(lslidar_msgs_v2::LslidarPacket().data);
  ////////////////////////////////////////////////////////////////////////
  ...
  int InputSocket::getPacket(lslidar_msgs_v2::LslidarPacketPtr &pkt)
  {
  ...
  /** @brief Get one lslidar packet. */
  int InputPCAP::getPacket(lslidar_msgs_v2::LslidarPacketPtr &pkt)
  {
    ...
    while (flag == 1)
    {
      ...
      if ((res = pcap_next_ex(pcap_, &header, &pkt_data)) >= 0)
      {
        ...
        { // difop
          ...
          if ((pkt->data[45] == 0x08 && pkt->data[46] == 0x02 && pkt->data[47] >= 0x09) || (pkt->data[45] > 0x08) || (pkt->data[45] == 0x08 && pkt->data[46] > 0x02))
          {
