...
namespace lslidar_driver
{
    ...
    lslidarDriver::lslidarDriver(ros::NodeHandle &node, ros::NodeHandle &private_nh) : nh(node),
                                                                                       ...
                                                                                       config_vert(true),
                                                                                       sweep_data(
                                                                                           new lslidar_msgs_v2::LslidarScan())
    {
        return;
    }
    ...
    bool lslidarDriver::loadParameters()
    {
        ...
        if (scan_start_angle < 0)
            scan_start_angle += 36000;
        return true;
    }
    ...
    bool lslidarDriver::lslidarC16Control(lslidar_msgs_v2::lslidar_control::Request &req,
                                          lslidar_msgs_v2::lslidar_control::Response &res)
    {
        ROS_WARN("--------------------------");
        // sleep(1);
        lslidar_msgs_v2::LslidarPacketPtr packet0(new lslidar_msgs_v2::LslidarPacket);
        packet0->data[0] = 0x00;
        packet0->data[1] = 0x00;
        int rc_msop = -1;
    ...
    void lslidarC16Driver::difopPoll()
    {
        ...
        lslidar_msgs_v2::LslidarPacketPtr difop_packet_ptr(new lslidar_msgs_v2::LslidarPacket);
        while (ros::ok())
        {
            // keep reading
     ...
     */
    bool lslidarC16Driver::poll(void)
    { // Allocate a new shared pointer for zero-copy sharing with other nodelets.
        lslidar_msgs_v2::LslidarPacketPtr packet(new lslidar_msgs_v2::LslidarPacket());
        ...
        if (use_gps_ts)
        {
            ...
            lslidar_msgs_v2::LslidarPacket pkt = *packet;
        ...
        for (size_t fir_idx = start_fir_idx; fir_idx < end_fir_idx; ++fir_idx)
        {
            ...
            sweep_data->points.push_back(lslidar_msgs_v2::LslidarPoint());
            lslidar_msgs_v2::LslidarPoint &new_point = sweep_data->points[sweep_data->points.size() - 1];
        ...
        if (end_fir_idx != SCANS_PER_PACKET)
        {
            ...
            sweep_data = lslidar_msgs_v2::LslidarScanPtr(new lslidar_msgs_v2::LslidarScan());
            ...
            for (int scan_fir_idx = 0; scan_fir_idx < SCANS_PER_FIRING_C32; ++scan_fir_idx)
            {
                ...
                if ("c32_1" == c32_type)
                {
                    ...
                    if (3 == c32_fpga_type)
                    {
                        // fpga v3.0
                        if (0 == scan_fir_idx || 1 == scan_fir_idx || 4 == scan_fir_idx || 8 == scan_fir_idx ||
                            9 == scan_fir_idx || 12 == scan_fir_idx || 16 == scan_fir_idx || 17 == scan_fir_idx || 21 == scan_fir_idx || 24 == scan_fir_idx ||
                            25 == scan_fir_idx || 29 == scan_fir_idx)
                        {
                            firings.azimuth[blk_idx * 32 + scan_fir_idx] += adjust_angle[3];
                        }
                        if (2 == scan_fir_idx || 3 == scan_fir_idx || 6 == scan_fir_idx || 10 == scan_fir_idx ||
                            11 == scan_fir_idx || 14 == scan_fir_idx || 18 == scan_fir_idx || 19 == scan_fir_idx || 23 == scan_fir_idx || 26 == scan_fir_idx ||
                            27 == scan_fir_idx || 31 == scan_fir_idx)
                        {
                            firings.azimuth[blk_idx * 32 + scan_fir_idx] += adjust_angle[2];
                        }
                             ...
                             adjust_diff_two < 350)
                    {
                        ...
                        if (0 == scan_fir_idx || 2 == scan_fir_idx || 4 == scan_fir_idx || 6 == scan_fir_idx ||
                            8 == scan_fir_idx || 12 == scan_fir_idx || 16 == scan_fir_idx || 20 == scan_fir_idx || 24 == scan_fir_idx || 26 == scan_fir_idx ||
                            28 == scan_fir_idx || 30 == scan_fir_idx)
                        {
                            firings.azimuth[blk_idx * 32 + scan_fir_idx] += adjust_angle[1];
                        }
                        if (1 == scan_fir_idx || 3 == scan_fir_idx || 5 == scan_fir_idx || 7 == scan_fir_idx ||
                            9 == scan_fir_idx || 13 == scan_fir_idx || 17 == scan_fir_idx || 21 == scan_fir_idx || 25 == scan_fir_idx || 27 == scan_fir_idx ||
                            29 == scan_fir_idx || 31 == scan_fir_idx)
                        {
                            firings.azimuth[blk_idx * 32 + scan_fir_idx] += adjust_angle[0];
                        }
