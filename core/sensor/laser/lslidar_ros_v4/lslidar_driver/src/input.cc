...
{
    // static const size_t packet_size = sizeof(lslidar_msgs_v4::LslidarPacket().data);
    ////////////////////////////////////////////////////////////////////////
    ...
    int InputSocket::getPacket(lslidar_msgs_v4::LslidarPacketPtr &pkt)
    {
        struct pollfd fds[1];
        fds[0].fd = sockfd_;
        fds[0].events = POLLIN;
    ...
    /** @brief Get one lslidar packet. */
    int InputPCAP::getPacket(lslidar_msgs_v4::LslidarPacketPtr &pkt)
    {
