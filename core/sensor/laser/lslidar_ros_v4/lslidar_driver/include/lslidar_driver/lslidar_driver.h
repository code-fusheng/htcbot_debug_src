...
#include <lslidar_msgs_v4/LslidarPacket.h>
#include <lslidar_msgs_v4/LslidarPoint.h>
#include <lslidar_msgs_v4/LslidarScan.h>
#include <lslidar_msgs_v4/LslidarC16Sweep.h>
#include <lslidar_msgs_v4/LslidarC32Sweep.h>
#include <lslidar_msgs_v4/LslidarScanUnified.h>
#include <lslidar_msgs_v4/LslidarPacket.h>
#include <lslidar_msgs_v4/lslidar_control.h>
#include <lslidar_msgs_v4/time_service.h>
#include <lslidar_msgs_v4/motor_speed.h>
#include <lslidar_msgs_v4/motor_control.h>
#include <lslidar_msgs_v4/data_port.h>
#include <lslidar_msgs_v4/dev_port.h>
#include <lslidar_msgs_v4/data_ip.h>
#include <lslidar_msgs_v4/destination_ip.h>
#include <regex>
#include <atomic>
...
namespace lslidar_driver
{
    ...
    public:
        ...
        bool powerOn(lslidar_msgs_v4::lslidar_control::Request &req,
                     lslidar_msgs_v4::lslidar_control::Response &res);

        bool motorControl(lslidar_msgs_v4::motor_control::Request &req,
                          lslidar_msgs_v4::motor_control::Response &res);

        bool motorSpeed(lslidar_msgs_v4::motor_speed::Request &req,
                        lslidar_msgs_v4::motor_speed::Response &res);

        bool timeService(lslidar_msgs_v4::time_service::Request &req,
                         lslidar_msgs_v4::time_service::Response &res);

        bool setDataPort(lslidar_msgs_v4::data_port::Request &req,
                         lslidar_msgs_v4::data_port::Response &res);

        bool setDevPort(lslidar_msgs_v4::dev_port::Request &req,
                        lslidar_msgs_v4::dev_port::Response &res);

        bool setDataIp(lslidar_msgs_v4::data_ip::Request &req,
                       lslidar_msgs_v4::data_ip::Response &res);

        bool setDestinationIp(lslidar_msgs_v4::destination_ip::Request &req,
    ...
    public:
        ...
        lslidar_msgs_v4::LslidarScanPtr sweep_data;
        lslidar_msgs_v4::LslidarScanPtr sweep_data_bak;
