...
namespace htcbot_control
{
  ...
  void HtcbotControl::switchHomePanel()
  {
    ...
    // 设置大小策略
    // mode_switch_box->setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
    // 建图开始
    ...
    pose_record_switch_button_->setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
    layout->addWidget(pose_record_switch_button_);
