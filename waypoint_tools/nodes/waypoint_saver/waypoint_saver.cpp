...
namespace WaypointSaverNS
{
    ...
    void WaypointSaver::init()
    {
        ...
        typedef message_filters::sync_policies::ApproximateTime<geometry_msgs::PoseStamped, geometry_msgs::PoseStamped> ApproSynch;
        message_filters::Synchronizer<ApproSynch> appro_synch(ApproSynch(100), sub_current_pose_base_sync_, sub_current_pose_gps_sync_);
