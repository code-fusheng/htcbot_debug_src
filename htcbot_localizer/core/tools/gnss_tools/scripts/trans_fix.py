...
class Transfix:
    ...
    def conf_path_callback(self, conf_msgs):
        ...
        # print("============ self.lane_path_points===========", self.lane_path_points)
    ...
    def fix_callback(self, fix_msg):
        ...
        # print("============self.pub_utm=============",self.pub_utm)
        if self.pub_utm:
    ...
    def trans_fix_2_gps(self, fix_msg):
        ...
        # print( "===========fix_msg.latitude, fix_msg.longitude,====== if self.is_load_path_points:=================",fix_msg.latitude, fix_msg.longitude,   self.gps_path_points)
        # 是否开启gps位姿辅助修正
    ...
    # 找到上一个GPS点
      if nearest_index != 0:
        prev_nearest_point = gps_points[nearest_index - 1]
        prev_nearest_index = nearest_index - 1
      else:
        prev_nearest_point = gps_points[nearest_index]
