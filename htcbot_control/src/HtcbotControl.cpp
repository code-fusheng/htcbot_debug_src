...
void HtcbotControl::switchMappingPanel()
{
  ...
  connect(mapping_start_button, &QPushButton::clicked, this, [this]() { pubMappingConf(1); });
  connect(mapping_end_button, &QPushButton::clicked, this, [this]() { pubMappingConf(-1); });
  connect(mapping_stop_button, &QPushButton::clicked, this, [this]() { pubMappingConf(2); });
