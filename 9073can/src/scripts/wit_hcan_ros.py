...
def find_ttyUSB():
    ...
    print('当前电脑所连接的 7777{} 串口设备共 {} 个: {}'.format('USB', len(posts), posts))
...
mag_range = [0, 0, 0]
global wt_imu
baudlist = [4800, 9600, 19200, 38400, 57600, 115200, 230400, 460800,2000000]
...
if __name__ == "__main__":
    ...
    find_ttyUSB()
    rospy.init_node("imu")
    port = rospy.get_param("~port", "/dev/ttyCH341USB0")
